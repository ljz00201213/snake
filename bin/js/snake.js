...
var Snake = (function (_super) {
    ...
    function Snake(colorNum, x, y) {
        ...
        if (x === void 0) { x = game.run.map.width / 2; }
        if (y === void 0) { y = game.run.map.height / 2; }
        var _this = _super.call(this) || this;
        _this.speedObj = { "slow": 2, "fast": 4, "rotation": 10 };
        _this.speedNow = "slow";
        //蛇身初始长度
        _this.snakeInitSize = 0.45;
        //蛇身长度
        _this.snakeLength = 24;
        //吃的豆子
        _this.kill = 0;
        _this.bodyArr = [];
        _this.pathArr = [];
        ...
        _this.loadImage("img/head" + _this.colorNum + ".png", 0, 0, 0, 0, new Handler(_this, _this.loaded, [x, y]));
        return _this;
    }
    ...
    Snake.prototype.addBody = function (x, y, r) {
        ...
        body.visible = false;
        body.alpha = 0;
        body.loadImage("img/body" + this.colorNum + ".png", 0, 0, 0, 0, new Handler(this, function () {
